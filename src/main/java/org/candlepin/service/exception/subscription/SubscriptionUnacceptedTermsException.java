...
/**
 * The SubscriptionUnacceptedTermsException is used to reject an activation attempt for a
 *  * subscription.
 */
public class SubscriptionUnacceptedTermsException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionUnacceptedTermsException() {
        super();
    }
     ...
     *  method.
     */
    public SubscriptionUnacceptedTermsException(String message) {
        super(message);
    }
     ...
     */
    public SubscriptionUnacceptedTermsException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public SubscriptionUnacceptedTermsException(String message, Throwable cause) {
        super(message, cause);
    }
}
