...
/**
 * The LiquibaseWrapperException represents the class of unexpected errors that may occur while
 * performing a database sync operation via Liquibase.
 */
public class LiquibaseWrapperException extends RuntimeException {
     ...
     */
    public LiquibaseWrapperException() {
        super();
    }
     ...
     *  method.
     */
    public LiquibaseWrapperException(String message) {
        super(message);
    }
     ...
     */
    public LiquibaseWrapperException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public LiquibaseWrapperException(String message, Throwable cause) {
        super(message, cause);
    }
