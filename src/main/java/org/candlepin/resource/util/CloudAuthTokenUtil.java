...
/**
 * A utility class for generating cloud authentication tokens
 */
public class CloudAuthTokenUtil {
    ...
    @Inject
    public CloudAuthTokenUtil(Configuration config, CertificateReader certificateReader) {
