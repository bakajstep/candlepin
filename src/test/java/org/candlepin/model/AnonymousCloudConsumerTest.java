...
public class AnonymousCloudConsumerTest extends DatabaseTestFixture {
    ...
    public void testSetIdWithNullValue() {
        ...
        assertThrows(IllegalArgumentException.class, () -> consumer.setId(null));
    }
    ...
    @Test
    public void testSetUuidWithNullValue() {
        AnonymousCloudConsumer consumer = new AnonymousCloudConsumer();

        assertThrows(IllegalArgumentException.class, () -> consumer.setUuid(null));
    }
