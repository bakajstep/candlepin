...
public class CloudRegistrationResourceTest {
    ...
    private CloudAuthTokenUtil mockTokenUtil;
    ...
    public void init() {
        ...
        this.mockTokenUtil = mock(CloudAuthTokenUtil.class);
        ...
        cloudRegResource = new CloudRegistrationResource(this.mockConfig, this.i18n,
            ...
            this.mockAnonCloudConsumerCurator, this.mockPoolCurator, this.mockJobManager, this.mockTokenUtil);
    }
    ...
    public void testCloudAuthorizeUsingV1Auth() {
        ...
        doReturn(expectedToken).when(mockTokenUtil).buildStandardRegistrationToken(principal,
            expectedOwnerKey);
    ...
    public void testCloudAuthorizeWithNoExistingOwnerFromAdapterUsingV2Auth() throws Exception {
        ...
        doReturn(expectedToken).when(mockTokenUtil).buildAnonymousRegistrationToken(principal,
