...
public class CloudAuthTokenUtilTest {
    ...
    public void beforeEach() {
        ...
        tokenUtil = new CloudAuthTokenUtil(config, certificateReader);
    }

    @Test
    public void testBuildStandardRegistrationTokenWithNullPrincipal() {
        assertThrows(IllegalArgumentException.class,
            () -> tokenUtil.buildStandardRegistrationToken(null, "owner-key"));
    }
    ...
    public void testBuildStandardRegistrationTokenWithInvalidOwnerKey(String ownerKey) {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> tokenUtil.buildStandardRegistrationToken(principal, ownerKey));
    }
    ...
    public void testBuildStandardRegistrationToken() throws Exception {
        ...
        String token = tokenUtil.buildStandardRegistrationToken(principal, expectedOwnerKey);
    ...
    public void testBuildAnonymousRegistrationTokenWithNullPrincipal() {
        assertThrows(IllegalArgumentException.class,
            () -> tokenUtil.buildAnonymousRegistrationToken(null, "owner-key"));
    }
    ...
    public void testBuildAnonymousRegistrationTokenWithInvalidOwnerKey(String ownerKey) {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> tokenUtil.buildAnonymousRegistrationToken(principal, ownerKey));
    }
    ...
    public void testBuildAnonymousRegistrationToken() throws Exception {
        ...
        String token = tokenUtil.buildAnonymousRegistrationToken(principal, consumerUuid);
    ...
    public void testBuildAnonymousRegistrationTokenWithNullPrincipalUsername() throws Exception {
        ...
        String token = tokenUtil.buildAnonymousRegistrationToken(principal, expectedOwnerKey);
