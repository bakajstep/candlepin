...
public class ProductExporterTest {
    ...
    private static final String REAL_PRODUCT_ID_1 = "12345";
    private static final String REAL_PRODUCT_ID_2 = "332211";
    private static final String PRODUCT_ID_1 = "MKT-prod";
    private static final String PRODUCT_ID_2 = "MKT-sub-prod";
